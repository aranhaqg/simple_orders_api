...
{:ok, product1} =
  SimpleOrdersApi.Catalog.create_product(%{name: "Blue Pencil", price: 10.5, sku: "blue-pencil"})

{:ok, _product2} =
  SimpleOrdersApi.Catalog.create_product(%{name: "Red Pencil", price: 10.5, sku: "red-pencil"})

{:ok, _product3} =
  SimpleOrdersApi.Catalog.create_product(%{
    name: "Orange Notepad",
    price: 50.9,
    sku: "orange-notepad"
  })
